 ...
 * @since  [产品/模块版本]
 */
public class TestWapServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        map.put("limit_pay", req.getParameter("no_credit"));//此字段屏蔽信用卡  添加屏蔽 不添加 不屏蔽。
        ...
        try {
            ...
            req.setAttribute("prepay_id", resultMap.get("prepay_id")); 
            req.getRequestDispatcher("index-payy.jsp").forward(req, resp);
        } catch (Exception e1) {
        	e1.printStackTrace();
